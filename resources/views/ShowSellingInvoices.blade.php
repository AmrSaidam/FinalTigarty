                            ...
                            <div class="">
                                ...
                                <table id="example2" class="table table-striped table-bordered table-hover dataTable no-footer" >
                                    ...
                                    <tr>
                                        ...
                                        <th style="text-align: center; border-right: 1px  "> تاريخ اصدار الفاتورة</th>
                                        <th style="text-align: center; border-right: 1px  ">توقيت اصدار الفاتورة</th>
