                ...
                <div class="hpanel">
                    ...
                    <div class="panel-body p-xl">
                        ...
                        <div class="row" style="padding-right:130px;padding-left:130px">
                            ...
                            <form method="post" action="{{route('makeSale')}}" name="SaleForm" id="SaleForm" class="form" role="form" novalidate="novalidate">
                           <input id =" unknown" type="hidden" name="_token" value="{{csrf_token()}}">
                                        ...
                                        <table class="table table-bordered table-striped" name="SaleTable" dir="rtl">
                                            ...
                                            <tr>
                                                ...
                                                <td><input id="productName" name="productName[]" type="text"
                                                           ...
                                                           style="width:100%; height: auto; right:0  !important;" class="form-control"  autocomplete="on" required="required">

                                                </td>

                                                {{--<span class="tooltip" title="This is my span's tooltip message!">Some text</span>--}}
                                            <td><input id="productAmount" name="productAmount[]"  placeholder=" الكمية  " pattern="^\d$"
                                                          style="width:100%; height: auto;" class="form-control"   maxlength="4" required="required"/></td><span id="auto"></span>
                                                <td id="productSum" name="productSum[]" class="productSumStyle"></td>

                                            </tr>
                                            {{--<tr>--}}
                                                {{--<td> <div id="delete" class="btn btn-danger delete-row"><i class="glyphicon glyphicon-minus"></i></div></td>--}}
                                            ...
                                            <tfoot>
                                            <tr style="font-size:18px;">
                                                <td class="alert alert-success" >   <div class="btn btn-success " style="margin-right: 1px"><i class="glyphicon glyphicon-plus"></i></div></td>
                                ...
                                <div class="row" style="animation: none !important;">
                                    ...
                                    <div class="col-lg-12" style=" text-align: center">
                                        ...
                                        <input id="cancel" name="cancel" type="reset" value ="ا لغاء"  class="btn btn-danger " />
                                        <input id="save" name="Save" type="submit" value="اعتماد" class="btn btn-primary"
                                               width="30px" />
                                    </div>
